...
//   "Existen estas operaciones para Calendar: obtener todos, buscar por id,
//    guardar y eliminar."
...
abstract class CalendarRepository {
  Future<List<CalendarEntity>> getAll();
  Future<CalendarEntity?> getById(String id);
  Future<void> save(CalendarEntity entity);
