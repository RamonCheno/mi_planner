...
//   "Existen estas operaciones para Perfil: obtener todos, buscar por id,
//    guardar y eliminar."
...
abstract class PerfilRepository {
  Future<List<PerfilEntity>> getAll();
  Future<PerfilEntity?> getById(String id);
  Future<void> save(PerfilEntity entity);
